...
var S_WINDOWS_PHONE_STORE = new Array( 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store', 'Windows Phone Store' );
...
var S_RELATED_LINKS_ARRAY = new Array( S_GITHUB, S_GOOGLE_PLAY, S_WINDOWS_STORE, S_WINDOWS_PHONE_STORE, S_CHROME_WEB_STORE, S_FIREFOX_MARKETPLACE, S_TIZEN_STORE, S_UBUNTU_APP_DIRECTORY );
